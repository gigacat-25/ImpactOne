    ...
    <div className="flex flex-col min-h-screen">
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t font-space-grotesk">
        <p className="text-xs text-muted-foreground text-center sm:text-left">
          &copy; {new Date().getFullYear()} ImpactOne. Developed by <a href="https://impactone.space" target="_blank" rel="noopener noreferrer" className="font-semibold text-primary hover:underline">Thejaswin P (1IC23CS082)</a> and <span className="font-semibold text-primary">Aarcha U (1IC21AI001)</span>
        </p>
